...
return {
	...
	cbf_formspec = function(tabview, name, tabdata)
		...
		local fs = "image[1.5,0.6;2.5,2.5;" .. core.formspec_escape(logofile) .. "]" ..
			...
			"style[devx_label;border=false;textcolor=#00fbff]" ..
			"button[0.1,3.8;5.3,0.5;devx_label;" .. core.formspec_escape("A Project by DevX Developments") .. "]" ..
			"button_url[1.5,4.5;2.5,0.8;homepage;terrixa.com;https://terrixa.com/]" ..
		...
		fs = fs .. "style[label_button2;border=false]" ..
			...
			"label[5.5,6.6;" .. core.formspec_escape("Based on the Luanti engine (LGPL v2.1+)") .. "]"
